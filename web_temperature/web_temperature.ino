...
uint16_t print_webpage(uint8_t *buf)
{
        ...
        switch (chk)
        {
            case 0: sprintf(temp_string, "%d", DHT11.temperature); break;
            case -1: sprintf(temp_string, "%d", -101); break;
            case -2: sprintf(temp_string, "%d", -102); break;
            default: sprintf(temp_string, "%d", -103); break;
        }
